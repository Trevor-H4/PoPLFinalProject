...
def serializedATN():
    return [
        ...
        2,1,2,1,3,1,3,1,4,1,4,1,5,1,5,1,6,1,6,1,7,1,7,1,7,1,7,1,8,1,8,3,
        ...
        1,0,0,0,0,59,1,0,0,0,1,61,1,0,0,0,3,63,1,0,0,0,5,65,1,0,0,0,7,69,
        ...
        5,110,0,0,66,67,5,111,0,0,67,68,5,116,0,0,68,6,1,0,0,0,69,70,5,61,
        0,0,70,8,1,0,0,0,71,72,5,35,0,0,72,10,1,0,0,0,73,74,5,63,0,0,74,
        12,1,0,0,0,75,76,5,44,0,0,76,14,1,0,0,0,77,78,5,100,0,0,78,79,5,
...
class GeniusGentlemenParsingLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "DEF", "FUNCDEF", "ANDOR", "IF", "EL", "ELSE", "WHILE", "FOR", 
